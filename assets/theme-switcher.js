...
(function() {
  ...
  function createToggleButton() {
    ...
    button.innerHTML = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#9fdcff" stroke-width="2">
        <circle cx="13.5" cy="6.5" r="1.5" fill="#9fdcff"></circle>
        <circle cx="17.5" cy="10.5" r="1.5" fill="#9fdcff"></circle>
        <circle cx="8.5" cy="7.5" r="1.5" fill="#9fdcff"></circle>
        <circle cx="6.5" cy="12.5" r="1.5" fill="#9fdcff"></circle>
