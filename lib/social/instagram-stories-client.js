...
// https://www.signalpilot.io/assets/social/stories/story-XXX.mp4
...
function getStoryUrl(storyNumber) {
  const paddedNum = String(storyNumber).padStart(3, '0');
  return `${SITE_URL}/assets/social/stories/story-${paddedNum}.mp4?v=${Date.now()}`;
}
