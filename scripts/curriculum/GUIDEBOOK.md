...
reading contract held, every figure recomputed. Slots 1 to 82 are rebuilt.
Slots 83 to 85 are still the old lessons.
...
ledger row saying what that found. Slots 1 to 82 have.

A module is **complete** when every slot in it is rebuilt. Modules 1 to 10 are
complete, which is slots 1 to 81. Module 11 is one of four: slot 82 is written
and 83 to 85 are still legacy.

### Open

- Full treatment of slots 83 to 85.
