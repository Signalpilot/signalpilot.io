...
reading contract held, every figure recomputed. Slots 1 to 69 are rebuilt.
Slots 70 to 85 are still the old lessons.
...
ledger row saying what that found. Slots 1 to 69 have.

A module is **complete** when every slot in it is rebuilt. Modules 1 to 7 are
complete, which is slots 1 to 61. Module 8 is eight of nine: slots 62 to 69 are
written and 70 is still legacy.
Modules 9 to 11 have not been started.

### Open

- Full treatment of slots 70 to 85.
...
- Ledger debts: percent spacing in five locales, Japanese inline-emphasis
  ...
  minority synonym for "net", and the word for "exposure" split across two or
  three variants in German, Japanese, Dutch and Russian.
