...
reading contract held, every figure recomputed. Slots 1 to 78 are rebuilt.
Slots 79 to 85 are still the old lessons.
...
ledger row saying what that found. Slots 1 to 78 have.

A module is **complete** when every slot in it is rebuilt. Modules 1 to 9 are
complete, which is slots 1 to 75. Module 10 is three of six: slots 76 to 78 are
written and 79 to 81 are still legacy. Module 11 has not been started.

### Open

- Full treatment of slots 79 to 85.
