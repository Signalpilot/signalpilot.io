...
reading contract held, every figure recomputed. Slots 1 to 79 are rebuilt.
Slots 80 to 85 are still the old lessons.
...
ledger row saying what that found. Slots 1 to 79 have.

A module is **complete** when every slot in it is rebuilt. Modules 1 to 9 are
complete, which is slots 1 to 75. Module 10 is four of six: slots 76 to 79 are
written and 80 to 81 are still legacy. Module 11 has not been started.

### Open

- Full treatment of slots 80 to 85.
